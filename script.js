const products = [
  {
    ...
    category: "Jetable",
    description: "Geek Bar Pulse populaire avec une saveur menthe fraîche.",
    price: 24,
  ...
  },
  {
    ...
    category: "Jetable",
    description: "Pastèque glacée avec une finition fraîche, réservée aux adultes.",
    price: 24,
  ...
  {
    id: "uwell-caliburn-x",
    name: "Uwell Caliburn X Pod Kit",
    category: "Kit pod",
    description: "Kit rechargeable avec airflow réglable, écran OLED et format compact.",
    price: 45,
    image: "https://files.myuwell.com/blob/product/caliburn-x/color/1.webp",
    colors: ["#dce8f4", "#ffffff"],
    stock: "En stock",
    stockClass: "in-stock",
    specs: {
      Type: "Kit pod rechargeable",
      Batterie: "Compacte",
      "Âge requis": "18+",
    },
  },
  {
    ...
    category: "Jetable",
    description: "Saveur fruitée Geek Bar Pulse avec notes de fraise et mangue.",
    price: 24,
  ...
  },
  {
    ...
    name: "Vaporesso XROS Mesh Pods",
    category: "Pods",
    description: "Pods mesh XROS de remplacement pour une saveur régulière.",
    price: 14,
    image: "https://www.vaporesso.com/hubfs/imgs/2022/pro/pod/xros-pod/new/box_0.6_standard.png",
    colors: ["#e4f7ff", "#ffffff"],
    stock: "Stock limité",
    stockClass: "low-stock",
    specs: {
      Type: "Pods de remplacement",
      Compatibilité: "Vaporesso XROS",
      "Âge requis": "18+",
    },
  },
  {
    id: "cuttwood-boss-reserve",
    name: "Cuttwood Boss Reserve Salt",
    category: "E-liquide",
    description: "E-liquide salt nic 30 mL aux notes de céréales, crème et banane.",
    price: 18,
    image: "https://vapordna.com/cdn/shop/files/CuttwoodSaltsBossReserveContents.png?v=1755906587&width=600",
    colors: ["#fff0bf", "#ffffff"],
    stock: "Rupture bientôt",
    stockClass: "low-stock",
    specs: {
      Format: "30 mL",
      Profil: "Céréales, crème, banane",
      "Âge requis": "18+",
    },
  },
];
